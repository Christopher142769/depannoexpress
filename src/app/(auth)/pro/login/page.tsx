...
export default function ProLoginPage() {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      ...
      toast.success("Bienvenue dans l'espace dépanneur !");
  ...
  return (
    <>
      <AuthCardSection>
        ...
        <h1 className="auth-glass-card__title">Connexion pro</h1>
        <p className="auth-glass-card__subtitle">
          Accédez à vos missions, votre GPS et votre portefeuille.
        </p>
      </AuthCardSection>
      ...
      <AuthCardSection>
        <p className="auth-muted">
          ...
          <Link href={LANDING_ROUTES.proSignup} className="auth-link auth-link--pro">
            Devenir dépanneur
          </Link>
          {" · "}
          <Link href={LANDING_ROUTES.demo} className="auth-link auth-link--pro">
            Démo
          </Link>
        </p>
      </AuthCardSection>
